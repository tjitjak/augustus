...
== Aantallen
//// 
Naast data, periodes en daarmee samenhangende vergeten gebeurtenissen, zijn aantallen slachtoffers al decennia lang onderwerp van discussie. Eveneens als het gaat om 'Nederlands-Indië'.

Het aantal slachtoffers in de Pacific Oorlog wordt geschat op 36.000.000. Oftewel 50% van het totaal aantal slachtoffers in WOII footnote:[http://www.pwencycl.kgbudge.com/C/a/Casualties.htm].

:sectnums:
//:leveloffset:

== Vòòr 1945 gevallen slachtoffers
...
Hoeveel daarvan Nederlands staatsburger waren, is onbekend. 
Veel japanse stukken / kamp-administratie is verloren gegaan.
